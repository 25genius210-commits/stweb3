...
st.title('지하철 승하차 인원 분석:sparkles:')

file = st.file_uploader('CSV 파일 업로드:sparkles:', type='csv')
...
if file is not None:
    ...
    st.header('특정역 승하차 인원 변화:sparkles:')
    ...
    st.header('승차 인원 TOP 10:sparkles:')
    ...
    st.header('하차 인원 TOP 10:sparkles:')
